export declare namespace VectorUtils {
    ...
    function isParallel(dot: number, tolerance?: number): boolean;
    ...
    function rotateAround(point: [number, number, number], axis: [number, number, number], angle: number): [number, number, number];
}
